const Toolbar = () => {
    return (
        <div className="w-full flex flex-row justify-between items-center">
            ...
            <section>
                <button className="border-2 border-white/5 font-semibold rounded-lg py-2 px-4 cursor-pointer bg-[#FF6B2B] text-white shadow-[0_0_15px_5px_rgba(255,107,43,0.4)]">
                    ▷ Run
                </button>
            </section>
        </div>
